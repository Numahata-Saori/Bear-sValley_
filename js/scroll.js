...
function PageTopCheck(){
    ...
    var secondTop =  $("#design").offset().top - 150; //#designの上から150pxの位置まで来たら
...
$('.scroll-top a').click(function () {
	...
	if (elmHash == "#design") {//もし、リンク先のhref の後が#designの場合
		var pos = $(elmHash).offset().top;
		$('body,html').animate({scrollTop: pos}, pos); //#designにスクロール
	}else{
